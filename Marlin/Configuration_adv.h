...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.02        // (mm) Compression length applying to all extruders //DM After calibration
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG              // Print debug information to serial during operation. Disable for production use.
  //#define EXPERIMENTAL_SCURVE   // Allow S-Curve Acceleration to be used with LA. //DM
