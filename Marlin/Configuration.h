...
// BUILD NOTES - DM
// Configured for CR10-V2 with SKR3 v3 (STM32H723VG)
// Hotend is Biqu H2 V2S Lite - High Flow 0.6 nozzle
// With BL Touch & OE Filament Runout Sensor mounted to hotend assembly
// Added support for S-Curve, Linear Advance, Remaining time etc
// 5.9.23 Disabled S-Curve Acceleration. Enabled Classic Jerk. Set motor current for E0 to 800
// Added calibrated Linear Advance (0.2)
// Changed filament runout to not remove filament
// Modified M600.cpp to set unload_length to 0
...
#define STRING_CONFIG_H_AUTHOR "S3DP, CR-10 V2)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V3_0 //DM
#endif
...
#define CUSTOM_MACHINE_NAME "CR-10 V2 SKR3 2.1.x"
 ...
 *
 */
#define TEMP_SENSOR_0 5 //DM V2S LITE
...
#define HEATER_0_MAXTEMP 285 //DM
...
#define DEFAULT_RETRACT_ACCELERATION   500    // E acceleration for retracts //DM
 ...
 */
//#define Z_MIN_PROBE_PIN PC13 // Pin 32 is the RAMPS default //DM Changed to PC13
#define Z_MIN_PROBE_PIN PC13 // Pin 32 is the RAMPS default //Per https://teamgloomy.github.io/skr_3_h723_bltouch.html
 ...
 */
//#define Z_PROBE_SERVO_NR 0       // Defaults to SERVO 0 connector.//DM
...
#if ENABLED(PREHEAT_BEFORE_PROBING) //DM
